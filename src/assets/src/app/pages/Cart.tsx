  ...
  const [cartItems, setCartItems] = useState([
    {
      ...
      price: 199.99,
      quantity: 1,
      image: "https://images.unsplash.com/photo-1515940175183-6798529cb860?w=200",
      inStock: true,
    },
    {
      id: 2,
      ...
      price: 349.99,
      quantity: 1,
      image: "https://images.unsplash.com/photo-1519335553051-96f1218cd5fa?w=200",
      inStock: true,
    },
    {
      id: 5,
      ...
      price: 149.99,
      quantity: 2,
      image: "https://images.unsplash.com/photo-1589363358751-ab05797e5629?w=200",
      inStock: true,
    },
  ]);
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                      ...
                      <div className="md:col-span-2 md:text-center">
                        ...
                        <span className="text-lg text-white font-semibold">${item.price.toFixed(2)}</span>
                      </div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="border-t border-white/10 pt-4">
                  ...
                  >
                    ...
                    <span className="text-white font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">${total.toFixed(2)}</span>
                  </motion.div>
                </div>
              </div>
